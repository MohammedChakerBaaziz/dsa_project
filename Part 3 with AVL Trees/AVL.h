...
class AvlTree
{
  ...
  private:
    struct AvlNode
    {
        ...
        AvlNode( const Item & ele, AvlNode *lt, AvlNode *rt, int h = 0 )
          : element{ ele }, left{ lt }, right{ rt }, height{ h } { }

        AvlNode( Item && ele, AvlNode *lt, AvlNode *rt, int h = 0 )
     ...
     */
    void insert(  Item & x, AvlNode * & t )
    {
        if( t == nullptr )
            t = new AvlNode{ x, nullptr, nullptr };
        else if( x.get_id() < t->element.get_id() )
            insert( x, t->left );
        else if( t->element.get_id() < x.get_id() )
            insert( x, t->right );
    ...
    */
     ...
     * Set the new root of the subtree.
     */
    void removeItem_Avl(  Item & x, AvlNode * & t )
    {
        if( t == nullptr )
            return;   // Item not found; do nothing
        if( x.get_id() < t->element.get_id() )
            removeItem_Avl( x, t->left );
        else if( t->element.get_id() < x.get_id() )
            removeItem_Avl( x, t->right );
        else if( t->left != nullptr && t->right != nullptr ) // Two children
        {
            t->element = findMin( t->right )->element;
            removeItem_Avl( t->element, t->right );
        }
        else
        {
            AvlNode *oldNode = t;
     ...
     */
    bool contains(  Item & x, AvlNode *t ) const
    {
        if( t == nullptr )
            return false;
        else if( x.get_id() < t->element.get_id() )
